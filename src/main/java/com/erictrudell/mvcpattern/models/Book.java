package com.erictrudell.mvcpattern.models;
...
public class Book {
    ...
    @Size(min = 5, max = 200, message="Title does not match request format")
    ...
    @Size(min = 3, max = 40, message="Language does not match request format")
